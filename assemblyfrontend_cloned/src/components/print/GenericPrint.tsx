...
const GenericPrint: React.FC<GenericPrintProps> = ({
  ...
  return (
    <>
      <link rel="preload" href="/assets/fonts/AbyssinicaSIL-Regular.ttf" as="font" type="font/ttf" crossOrigin="anonymous" />
      <link rel="preload" href={logo} as="image" />
      <link rel="preload" href={slogan} as="image" />
      <style>
        {`
          @media print {
            .generic-print-container {
              ...
              font-family: 'Abyssinica', sans-serif !important;
            }
            .slogan-image {
        ...
        <div className="flex justify-between items-center mb-3 pb-4">
          <div className="flex items-center">
            <img
              src={logo}
              alt="Bank Logo"
              className="logo-image h-14 w-auto mr-3 print:h-12"
          ...
          <img
            src={slogan}
            alt="Bank Slogan"
            className="slogan-image h-10 w-auto print:h-8"
            onError={(e) => { e.currentTarget.src = '/assets/fallback-slogan.png'; }}
          />
        </div>
            ...
            <div className="space-y-1 text-base">
              ...
              <p className="flex flex-row">
                ...
                <span>
                  ...
                  የታደሰ መታወቂያ (የቀበሌ መታወቂያ፤ መንጃ ፈቃድ፤ ፓስፖርት ወይም ሌላ መረጃ)፣ ድርጅት ከሆነ
