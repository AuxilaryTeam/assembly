...
const GenericPrint: React.FC<GenericPrintProps> = ({
  ...
  return (
    <div className="bg-white p-14 mb-2 rounded-lg shadow-lg max-w-4xl mx-auto border border-gray-200 print:border-0 print:shadow-none print:pr-14 print:pl-14 print:max-w-full">
      ...
      {/* Shareholder Details */}
      <div className="mb-2 p-3 bg-gray-50 rounded print:p-2">
      ...
      <div className="mb-4 p-2 rounded mt-2 print:mt-2 print:text-xs">
        ...
        <div className="space-y-1 text-xs">
          <p className="flex flex-row">
            ...
            <span>
              የትርፍ ድርሻ ክፍፍሉ ተግባራዊ የሚሆነው የባንኩ ጠቅላላ ጉባዔ ከተከናወነ እና በትርፍ ክፍፍሉ ላይ ውሳኔ
              ከተሰጠ በኋላ እንደሆነ በትህትና እናሳውቃለን፡፡
            </span>
          </p>
          <p className="flex flex-row">
            <span className="font-semibold pr-2"> 2ኛ/</span>{" "}
            <span>
              የባንክ ሥራ አዋጅን ለማሻሻል በወጣው አዋጅ ቁጥር 1159/2019 መሠረት ማንኛውም ባለአክሲዮን የትርፍ
              ድርሻው የሚከፈለው ወይም የትርፍ ድርሻውን ለካፒታል ማሳደጊያ እንዲውል የሚደረገው ባለአክሲዮኑ ኢትዮጵያዊ
              ዜግነት ወይም ትውልደ ኢትዮጵያዊ መሆናቸውን የሚገልጽ የኢትዮጵያ ዲጂታል መታወቂያ ካርድ፣ የታደሰ
              መታወቂያ (የቀበሌ መታወቂያ፤ መንጃ ፈቃድ፤ ፓስፓርት ወይም ሌላ መረጃ)፣ ድርጅት ከሆነ የድርጅቱ
              ባለአክሲዮኖች በሙሉ ኢትዮጵያዊ ዜግነት ወይም ትውልደ ኢትዮጵያውያን መሆናቸውን የሚያረጋግጥ የመመሥረቻ
              ጽሑፍ ወይም ሌላ ተቀባይነት ያለው ማስረጃ ዋናውን ከኮፒ ጋር በመያዝ በባንኩ ዋናው መ/ቤት አክስዮን እና
              ኢንቨስትመንት ክፍል በአካል በመቅረብ የተዘጋጀውን ፎርም ሞልቶ ሲፈርም መሆኑን በትህትና እናሳውቃለን፡፡
            </span>
          </p>
        </div>
      </div>
