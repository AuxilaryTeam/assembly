  ...
  const handleSearch = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Error fetching shareholder data.",
        duration: 4000,
      });
    }
  };
  ...
  const handleVoteSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!selectedVote) {
      toast({
        ...
        description: "Please select a vote before submitting.",
        duration: 4000,
      });
    ...
    try {
      ...
      toast({
        ...
        description: `Your vote '${selectedVote}' was submitted successfully!`,
        duration: 4000,
      });
  ...
  const fetchData = async (issueId: number) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Something went wrong while loading the issue. Please try again.",
        duration: 4000,
      });
    }
  };
